...
## 2026-08-27 — Johto League replay and simulation elevation
...
- Verified 60 tests, TypeScript, ESLint, `git diff --check`, and a 23-page production build. Commit `43ab153` is on `origin/main`; the Vercel replay returns HTTP 200 with title, DEM provenance, and narrative-source attribution present.
