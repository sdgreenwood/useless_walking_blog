...
- Local verification for the California/Crystal correction passes Goethite's grid audit, 55 tests, strict TypeScript, clean ESLint, the 22-page production build, desktop cutaway seek/canvas checks, and 390 px replay/research no-overflow checks. The known OpenFreeMap `wood-pattern` warning remains non-blocking.
